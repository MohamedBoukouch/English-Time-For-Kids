...
class _MultiplicationPageState extends State<MultiplicationPage> {
  ...
  //  Generate 30 multiplication questions
  ...
  List<Map<String, dynamic>> generateQuestions() {
    ...
    while (allQuestions.length < 30) {
      int num1 = random.nextInt(10) + 1; // Generate numbers up to 10
      int num2 = random.nextInt(10) + 1; // Generate numbers up to 10
      int correctAnswer = num1 * num2;

      // Ensure choices are distinct and don't include duplicates
      List<int> choices = [correctAnswer];
      while (choices.length < 3) {
        int randomChoice = random.nextInt(100) + 1; // Generate choices up to 100
